...
function renderTrainers(trainer){
  ...
  var addPokemon =  document.createElement("button")var releasePokemon =  document.createElement("button")

  addPokemon.innerHTML = "Add Pokemon"
  var pokeList =  document.createElement("ul")
  var item = document.createElement("li")
  item.innerText = "PokeName (Nickname)"
  
  releasePokemon.innerHTML = "RELEASE Pokemon"  
