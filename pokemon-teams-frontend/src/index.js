...
console.log(
  "%c Welcome to pokèmon trainers!",
  "color: yellow; -webkit-text-stroke-width: 1px; -webkit-text-stroke-color: blue;  font-size: 50px;"
);
...
fetch(TRAINERS_URL)
  ...
  .then((trainers) => {
    ...
    <div class="card" data-id=${trainer.id}><p>${trainer.name}</p>
      ...
      const trainerUl = document.querySelector(
        `[data-trainer-ul-id='${trainer.id}']`
      );
